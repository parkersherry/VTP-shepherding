...
for seedIndex = 1:Nseeds
    ...
    for memIndex = 1:numel(memory)
        ...
        fnameDog = '/Users/mikey/Summer 2025/MatlabGitVTP/MATLAB_code/Memory Vs Everything/mem_' +string(memory(memIndex))+ '_run_'+string(seedIndex)+'.mat';


        serialSandbox(fnameDog,N,3.3,Inf,1500,tar,memory(memIndex),posSeed,angSeed,1,'zero');
